...
export default function CalendarioPage() {
  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-darkBg p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          <Calendar className="w-8 h-8 text-primary" />
          <div>
            <h1 className="text-3xl font-bold">Calendário de Demandas</h1>
            <p className="text-slate-500 text-sm">Visão geral dos prazos da equipe</p>
          </div>
        </div>

        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm" style={{ height: '700px' }}>
          <Calendar
            localizer={localizer}
            events={eventos}
            startAccessor="start"
