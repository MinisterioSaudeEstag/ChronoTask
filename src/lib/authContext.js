...
export function AuthProvider({ children }) {
  ...
  const ADMINS_LIST = ["Eliane Leal", "Maria Juliana", "Monalisa Aquino", "Matheus do Nascimento", "Maria Luna"];

  const STAFF_LIST = ["Arthur Vinícius", "Ana Aparecida de Freitas Lima", "Giselly Soares", "Maria Angelita de Lucena"];
